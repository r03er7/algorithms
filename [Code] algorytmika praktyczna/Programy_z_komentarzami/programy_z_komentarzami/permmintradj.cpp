...
// Funkcja generuje wszystkie permutacje zbioru p z uzyciem minimalnej liczby transpozycji sasiednich
...
int main() {
	VI p;
// Stworz wektor liczb {1,2,3}
	FOR(x,1,3) p.PB(x);
// Wygeneruj permutacje zbioru {1,2,3} z uzyciem minimalnej liczby transpozycji sasiednich
